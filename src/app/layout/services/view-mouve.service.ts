...
export class ViewMouveService {
  private baseUrl = globals.apiBaseUrl + 'viewMouve';
  ...
  getTOTCaMargesDetailsByClient(
    ...
    return this.http.get<any[]>(
      ...
      `${this.baseUrl}/search/getTOTCaMargesDetailsByClient`, {params} );
  }
  ...
  getCAClient(op: string): Observable<string> {
    return this.http.get<string>(`${this.baseUrl}/search/CAClient?op=${op}`);
   }

   getMAClient(op: string): Observable<string> {
    return this.http.get<string>(`${this.baseUrl}/search/MAClient?op=${op}`);
   }
   // tslint:disable-next-line:max-line-length
   getEvolutionCA(client: string, article: string, fournisseur: string, typologieClient: string, famille: string, vendeur: string, secteur: string, consRev: string, sfamille: string, zone: string, represant: string, groupe: string  ): Observable<any> {
    // tslint:disable-next-line:max-line-length
    const params = new HttpParams()
    .set('client', client)
    .set('article', article)
    ...
    return this.http.get<any[]>(
      // tslint:disable-next-line:max-line-length
      `${this.baseUrl}/search/getEvolutionCA`, {params} );
   }
