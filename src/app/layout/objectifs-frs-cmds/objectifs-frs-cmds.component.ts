...
@Component({
  selector: 'app-objectifs-frs-cmds',
  templateUrl: './objectifs-frs-cmds.component.html',
  styleUrls: ['./objectifs-frs-cmds.component.scss']
})
export class ObjectifsFrsCmdsComponent implements OnInit {
  @ViewChild('op')
  ...
  async Afficher(e) {
    ...
    if ( this.SelectedFournisseur !== null && this.SelectedFournisseur !== undefined) {
     if (this.listeFourniseur[0].plafond !== '0.0') {
       ...
       await this.evolutionService
       .InsertEvolution(this.four.code , String(i), libMois)
       .toPromise()
       .then(data => {
      ...
      await this.evolutionService
      .UpdateEvolution(this.four.code)
      .toPromise()
      .then(data => {
    ...
    .toPromise()
    .then(data => {
      this.listeObjectifsCmdsFours = data;
      console.log('liste frs = ', this.listeObjectifsCmdsFours);
     ...
     doc1.text('Evolution Objectif/CmdsFournisseur', 50, 27);
      ...
      doc1.text('Evolution', 180, 40, 'right');
      doc1.text('Ventes  ', 203, 40, 'right');
      // creer la ligne
      doc1.setFontStyle('bold');
      ...
      let  numPage = 1;
        ...
        for (const obj of this.listeObjectifsCmdsFours) {
          console.log('obj', obj);
          doc1.setFontSize(10);
          doc1.setFontStyle('Arial');
          ...
          if (y > 277) {
            ...
            doc1.text('Evolution ', 180, 17 , 'right');
            doc1.text('Ventes ', 203, 17, 'right');
            // creer la ligne
            doc1.setFontStyle('bold');
            doc1.line(9, 20, 205, 20);
            y = 24;
