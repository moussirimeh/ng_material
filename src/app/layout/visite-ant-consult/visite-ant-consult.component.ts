...
@Component({
  selector: 'app-visite-ant-consult',
  templateUrl: './visite-ant-consult.component.html',
  styleUrls: ['./visite-ant-consult.component.scss'],
  providers: [MessageService, DatePipe],
})
export class VisiteAntConsultComponent implements OnInit {
  ...
  */
  initialiser() {
    ...
    this.showElementsForConsult = false;
    this.codeDest1 = '';
    this.codeDest2 = '';
    this.codeDest3 = '';
    this.delai1 = '';
