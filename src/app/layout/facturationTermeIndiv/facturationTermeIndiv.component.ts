...
@Component({
  selector: 'app-facturationtermeindiv',
  templateUrl: './facturationTermeIndiv.component.html',
  styleUrls: ['./facturationTermeIndiv.component.scss'],
  providers: [DatePipe],
})
export class FacturationTermeIndivComponent implements OnInit {
  @ViewChild('gridFact')
  ...
  async afficher(e) {
    ...
    if (
      ...
      if (this.selectedClient.comm === 'O') {
        ...
        this.parCmd = false;
        await this.facturationTermeIndivService
          .facturationTermeIndivParBl(this.selectedClient.code, this.datePipe.transform(this.date, 'dd/MM/yyyy'))
          .toPromise()
          .then((data) => {
            temp = data['_embedded'].facturationTermeIndiv;
          });
      ...
      if (this.IdentifClientVisible && this.factures.length > 0) {
