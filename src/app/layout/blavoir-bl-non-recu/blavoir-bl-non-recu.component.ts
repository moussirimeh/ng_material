...
@Component({
  selector: 'app-blavoir-bl-non-recu',
  templateUrl: './blavoir-bl-non-recu.component.html',
  styleUrls: ['./blavoir-bl-non-recu.component.scss'],
  providers: [DatePipe, ExcelService, ToolbarService]
})
export class BlavoirBlNonRecuComponent implements OnInit {
