...
@Component({
  selector: 'app-deblocageclts',
  templateUrl: './deblocageclts.component.html',
  styleUrls: ['./deblocageclts.component.scss'],
  providers: [ToolbarService],
})
export class DeblocagecltsComponent implements OnInit {
  ...
  async deblocageNiv1(e) {
    ...
    if (this.selectedClient.cadnat === 'O') {
      ...
      this.messageService.add({
        ...
        severity: 'error',
        summary: 'Erreur',
        detail: 'Code Client est bloqué definitivement !'
      });*/
